...
- **[MeshCore Integration](https://github.com/fgravato/meshcore-hass)** — must be installed and configured. The cards read hub, node, contact, and channel data directly from the devices and entities registered by this integration.
